...
class SeleniumTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        ## toggle the line above will hide/show the chrome browser window 
        ##   when you run `flask test`
    ...
    def test_admin_home_page(self):
        ...
        self.assertTrue(re.search('Sign\sIn', self.client.page_source))
        ...
        self.assertTrue(re.search('your\smind', self.client.page_source))

        # navigate to the user's profile page
        self.client.find_element_by_link_text('My Profile').click()
